				...
				<div class="toggleblock">
					<table cellpadding="0" cellspacing="0" border="0" id = "done_{$lists[list].ID}">
						...
						{/if}
							...
							<tr>
								<td class="a">{if $adminstate > 0}<a class="butn_checked" href="javascript:closeElement('task_{$lists[list].oldtasks[oldtask].ID}','managetask.php?action=open&amp;tid={$lists[list].oldtasks[oldtask].ID}&amp;id={$lists[list].ID}');" title="{#open#}"></a>{/if}</td>
								<td class="b">
									<div class="toggle-in">
