				...
				<div id="message" class="descript">
					...
					<div class="inwrapper">
						<ul>
							...
							<li>
								<div class="itemwrapper" id="fli_{$message.files[file].ID}">
										...
										<tr>
											...
											<td class="rightmen" valign="top">
												<div class="inmenue">
													...
													<a class="del" href="javascript:void(0);" onclick = "javascript:confirmfunction('{$langfile.confirmdel}','deleteElement(\'fli_{$message.files[file].ID}\',\'managefile.php?action=delete&id={$message.project}&file={$message.files[file].ID}\')');" title="{#delete#}"></a>{/if}
												</div>
											</td>
										</tr>
										<tr>
