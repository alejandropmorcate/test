...
{/if}
				...
				<h2>{#editmessage#}</h2>
					...
					<fieldset>
						...
						<div class="row"><label for="text">{#text#}</label><div class="editor"><textarea name="text" id="text" required="0" realname="{#text#}" rows="3" cols="1" >{$message.text}</textarea></div></div>
